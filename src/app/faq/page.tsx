  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "KAUS Coin은 무엇인가요?",
          a: "KAUS Coin은 차세대 DeFi 플랫폼으로, 완전한 투명성과 온체인 검증이 가능한 암호화폐 생태계를 제공합니다. 스테이킹, 거버넌스, 유동성 채굴 등 다양한 기능을 통합한 혁신적인 프로젝트입니다."
        },
        {
          q: "어떻게 KAUS Coin을 구매할 수 있나요?",
          a: "KAUS Coin은 주요 탈중앙화 거래소(DEX)인 Uniswap, PancakeSwap 등에서 구매하실 수 있습니다. 메타마스크나 다른 Web3 지갑을 연결한 후 ETH 또는 USDT로 교환하실 수 있습니다."
        },
        {
